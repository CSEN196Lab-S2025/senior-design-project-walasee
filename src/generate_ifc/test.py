'''
YQ: bruh. This is sample code given on the ifc open shell 
documentation (https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#create-a-simple-model-from-scratch),but when I run it it gives me these errors:

(generateifc) D:\D_Santa Clara University\SENIOR 2024-2025\senior-design-project-walasee\src\generate_ifc>python test.py
...
I can't get api calls to work, so i gotta resort to what they call "manual method". Meaning code in each individual entity (project, site, building, storey, wall, pipe segment, etc.)
'''
